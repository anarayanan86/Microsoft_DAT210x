...
# SVC "Best" 2D Score SVC "Best" 2D Score - correct
# (Not sure why this result is correct - I got the same score (98.361) for all 4 tests)
#
# Lab Question 2:
# Change iterations from 5000 to 200,000 and then re-run your lab with the default parameters.
# Ensure you don't have anything else processor intensive running on your machine for the duration of time it takes
# to do its number crunching (should be 1-10 minutes on modern laptops).
# Which of these four computations was *fastest* to calculate?
# SVC Testing Time SVC Testing Time - correct
